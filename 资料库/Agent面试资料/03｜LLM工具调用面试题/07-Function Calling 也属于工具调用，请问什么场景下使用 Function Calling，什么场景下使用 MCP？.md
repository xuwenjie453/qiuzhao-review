...
> 本文搬运自[小林面试笔记《7. Function Calling 也属于工具调用，请问什么场景下使用 Function Calling，什么场景下使用 MCP？》](https://xiaolinnote.com/ai/tools/7_fc_vs_mcp_usage.html)官方页面，版权归原作者所有，仅供个人学习使用。
