...
> 本文搬运自[小林面试笔记《10. MCP 和 Agent Skill 的区别是什么？》](https://xiaolinnote.com/ai/tools/10_mcp_vs_skill.html)官方页面，版权归原作者所有，仅供个人学习使用。
...
用户对 Agent 说「帮我审查一下这次提交的代码」。Agent 收到任务后，先扫描自己可用的 Skill 列表，发现有一个叫 code-review 的 Skill 和这个任务匹配度很高。于是 Agent 加载它的 <a href="http://SKILL.md" rel="noopener noreferrer" target="_blank">SKILL.md</a> 正文，读取里面的执行流程。这份 <a href="http://SKILL.md" rel="noopener noreferrer" target="_blank">SKILL.md</a> 长这个样子：
...
你看，<a href="http://SKILL.md" rel="noopener noreferrer" target="_blank">SKILL.md</a> 的作用就是告诉 Agent「做什么、按什么顺序做」，它就是一份操作手册。
