...
EVENTS = {
    ...
    'Algorithms': ['SKILL_IDENTIFIED', 'SKILL_REPAIR', 'REPAIR_SUCCESS', 'PATTERN_RECOGNIZED', 'INDEPENDENT_IMPLEMENTATION',
                   'TEST_PASS', 'TRANSFER_PASS', 'LEARNING_VERIFIED'],
    'Projects': ['CASE_ATTEMPT', 'REPAIR_SUCCESS', 'REASONING_SUCCESS', 'TRADEOFF_SUCCESS', 'FAILURE_MODE_SUCCESS',
